            ...
            <Grid container spacing={3} sx={{ textAlign: 'center' }}>
              <Grid item xs={12}>
                ...
                >
                  ...
                  >
                    Explore FarmWise Rwanda{' '}
                    <Typography
                      variant="h1"
                      component="span"
                      sx={{
                        fontSize: 'inherit',
                        background: 'linear-gradient( 90deg,rgb(141, 182, 0), rgb(34, 139, 34), rgb(141, 182, 0) ) 0 0 / 400% 100%',
                        color: 'transparent',
              ...
              <Grid container justifyContent="center" item xs={12}>
                <Grid item xs={8}>
                  ...
                  >
                    ...
                    >
                  FarmWise is an innovative mobile app tailored for smallholder farmers in Rwanda. Built on cutting-edge research, FarmWise empowers farmers with localized weather forecasts, crop-specific advice, and market insights, all accessible even offline. Join the movement and revolutionize farming with FarmWise!
                    </Typography>
                  </motion.div>
                </Grid>
              </Grid>
                ...
                >
                  <Grid container spacing={3} justifyContent="center">
                    ...
                    <Grid item>
                      ...
                      <Typography variant="h4">1.5K+</Typography>
                    </Grid>
                  </Grid>
                </motion.div>
              </Grid>
