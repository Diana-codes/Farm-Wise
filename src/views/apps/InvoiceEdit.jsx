  ...
  return (
    <Formik
      ...
      initialValues={{
        ...
        tax: list.tax || 0,
        notes: list.notes || '',
        country: invoiceMaster.countries[0] || null
      }}
...
EditForm.propTypes = { list: PropTypes.any, invoiceMaster: PropTypes.any, key: PropTypes.oneOfType([PropTypes.string, PropTypes.number]) };
